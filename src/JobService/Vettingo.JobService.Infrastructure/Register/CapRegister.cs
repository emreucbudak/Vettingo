...
namespace Vettingo.JobService.Infrastructure.Register
{
    public static class CapRegister
    {
        public static void AddJobCap(this IServiceCollection services, IConfiguration configuration)
        {
            services.AddTransient<JobApplicationCreatedConsumer>();
                ...
                .AddCap(options =>
            {
                ...
                options.DefaultGroupName = "vettingo.job-service";
                ...
                .AddSubscriberAssembly(
                    typeof(JobApplicationCreatedConsumer));
        }
    }
}
