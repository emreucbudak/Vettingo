...
{
    public class GetJobPostingByIdQueryHandler(IJobPostingRepository jobPostingRepository) : IRequestHandler<GetJobPostingByIdQueryRequest, GetJobPostingByIdQueryResponse>
    {
