...
public sealed class CreateJobPostingCommandRequestValidator : AbstractValidator<CreateJobPostingCommandRequest>
{
    public CreateJobPostingCommandRequestValidator()
    {
