...
using Vettingo.ApplicationService.Infrastructure.Messaging;

namespace Vettingo.ApplicationService.Infrastructure.Register;

public static class CapRegister
{
    public static IServiceCollection AddApplicationCap(
        ...
        IConfiguration configuration)
    {
        ...
        services.AddScoped<
            IJobApplicationCreatedPublisher,
            JobApplicationCreatedPublisher>();
        services
            .AddCap(options =>
            {
                ...
                options.DefaultGroupName = "vettingo.application-service";
